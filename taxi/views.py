...
from .forms import DriverCreationForm, DriverForm, DriverLicenseUpdateForm
...
def add_driver(request, pk):
    ...
    if request.user not in Car.objects.all():
        car.drivers.add(request.user)
        return HttpResponseRedirect(reverse("taxi:car-detail", args=[str(pk)]))
