...
from .forms import DriverCreateForm, DriverUpdateLicenseForm, CarForm
...
@login_required
def assign_remove_to_car_view(request, pk):
    current_user = request.user
    current_car = Car.objects.get(id=pk)
    if current_user in current_car.objects.drivers.all():
