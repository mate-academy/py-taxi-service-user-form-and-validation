...
def validate_license_number(value):
    ...
    if len(license_number) != 8:
        raise ValidationError("License_number should consist only of 8 characters")
    if not license_number[:3].isupper() or not license_number[:3].isalpha():
        raise ValidationError("First 3 characters of license_number should be uppercase letters")
