...
from .views import (
    ...
    ManufacturerDeleteView, DriverCreateView, DriverLicenseUpdateView, DriverDeleteView, assign_or_delete_driver,
)
...
urlpatterns = [
    ...
    path('cars/<int:pk>/assign/', assign_or_delete_driver, name="assign-driver"),
